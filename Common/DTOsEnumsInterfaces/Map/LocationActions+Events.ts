// Location *Action* enums are player's choices of action which will be available to choose based on the location that party is currently in.
...
export enum LocationEventEnum {
    ...
    //Training events
    AttributeTrain = "attributeTrain", 
    ArtisanTrain = "artisanTrain", 
    ProficiencyTrain = "proficiencyTrain", 
