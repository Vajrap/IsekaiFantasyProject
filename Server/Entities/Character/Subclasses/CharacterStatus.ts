...
import {
  ElementTypes,
  FundamentalElementTypes,
} from "../../../../Common/DTOsEnumsInterfaces/ElementTypes";
...
export class CharacterStatus {
  ...
  randomPlayerStatus() {
    for (const attribute in this.attributes) {
      this.attributes[attribute as keyof typeof this.attributes].base =
        Dice.roll(DiceEnum.ThreeD4).sum;
    }
    for (const proficiency in this.proficiencies) {
      this.proficiencies[proficiency as keyof typeof this.proficiencies].base =
  ...
  getDominateElement(): { element: FundamentalElementTypes; value: number } {
    ...
    for (const element in this.elements) {
      const value =
        this.elements[element as keyof typeof this.elements].base +
        this.elements[element as keyof typeof this.elements].bonus;
    ...
    for (const element in this.elements) {
      ...
      if (value > highestElement.value) {
        ...
        secondHighestElement = {
          element: element as FundamentalElementTypes,
          value,
        };
      }
    }
  ...
  intelligence(): number {
    return (
      this.attributes.intelligence.base +
  ...
  leadership(): number {
    return (
      this.attributes.leadership.base +
  ...
  willpower(): number {
    return (
      this.attributes.willpower.base +
  ...
  dexterity(): number {
    return (
      this.attributes.dexterity.base +
  ...
  bareHand(): number {
    return (
      this.proficiencies.bareHand.base +
  ...
  dagger(): number {
    return (
      this.proficiencies.dagger.base +
  ...
  shield(): number {
    return (
      this.proficiencies.shield.base +
  ...
  magicWand(): number {
    return (
      this.proficiencies.magicWand.base +
  ...
  woodcutting(): number {
    return (
      this.artisans.woodcutting.base +
