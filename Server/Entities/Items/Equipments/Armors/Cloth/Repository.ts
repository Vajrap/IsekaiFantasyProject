...
const cloth_robe = new Cloth({
    ...
    cost: { baseCost: 100, bonusCost: 0, possibleDeviation: 0.2 },
    weight: 1500,
    tier: Tier.common,
...
const cloth_common = new Cloth({
    ...
    cost: { baseCost: 80, bonusCost: 0, possibleDeviation: 0.2 },
    weight: 1400,
    tier: Tier.common,
    armorType: ArmorType.cloth,
    material: 'Cotton',
...
const cloth_fine = new Cloth({
    ...
    cost: { baseCost: 300, bonusCost: 0, possibleDeviation: 0.2 },
    weight: 1350,
    tier: Tier.uncommon,
    armorType: ArmorType.cloth,
...
const cloth_plain = new Cloth({
    ...
    cost: { baseCost: 90, bonusCost: 0, possibleDeviation: 0.2 },
    weight: 1400,
    tier: Tier.common,
    armorType: ArmorType.cloth,
    material: 'Cotton',
...
const cloth_rugged = new Cloth({
    ...
    cost: { baseCost: 120, bonusCost: 0, possibleDeviation: 0.2 },
    weight: 1600,
    tier: Tier.common,
    armorType: ArmorType.cloth,
...
const cloth_simple = new Cloth({
    ...
    cost: { baseCost: 70, bonusCost: 0, possibleDeviation: 0.2 },
    weight: 1400,
    tier: Tier.common,
    armorType: ArmorType.cloth,
    material: 'Cotton',
