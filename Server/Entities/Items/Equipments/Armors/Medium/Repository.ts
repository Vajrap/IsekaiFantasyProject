...
const medium_studded = new MediumArmor({
    ...
    cost: { baseCost: 1500, bonusCost: 0 },
    weight: 7000,
    tier: Tier.common,
...
const medium_chain = new MediumArmor({
    ...
    cost: { baseCost: 3000, bonusCost: 0 },
    weight: 10000,
    tier: Tier.common,
    armorType: ArmorType.medium,
    material: 'Metal',
...
const medium_scale = new MediumArmor({
    ...
    cost: { baseCost: 5000, bonusCost: 0 },
    weight: 12000,
    tier: Tier.common,
    armorType: ArmorType.medium,
    material: 'Metal',
...
const medium_breastplate = new MediumArmor({
    ...
    cost: { baseCost: 8000, bonusCost: 0 },
    weight: 10000,
    tier: Tier.uncommon,
    armorType: ArmorType.medium,
    material: 'Metal',
...
const medium_half_plate = new MediumArmor({
    ...
    cost: { baseCost: 10000, bonusCost: 0 },
    weight: 15000,
    tier: Tier.uncommon,
    armorType: ArmorType.medium,
    material: 'Metal',
