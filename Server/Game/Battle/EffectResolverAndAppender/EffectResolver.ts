...
class EffectResolverFunction {
  ...
  static paralyse(character: Character): boolean {
    const save = character.saveRoll(CharacterStatusEnum.endurance);
  ...
  static fear(character: Character): boolean {
    const save = character.saveRoll(CharacterStatusEnum.willpower);
  ...
  static entangled(character: Character): boolean {
    ...
    const save = character.saveRoll(CharacterStatusEnum.strength);
    if (save < 10) {
      return false;
    } else {
      return true;
  ...
  static cleanse(character: Character): boolean {
    ...
    if (save >= 12) {
      ...
      character.buffsAndDebuffs.stun = rollCleanse(
        character.buffsAndDebuffs.stun,
      );
      character.buffsAndDebuffs.blind = rollCleanse(
        character.buffsAndDebuffs.blind,
      );
      character.buffsAndDebuffs.slow = rollCleanse(
        character.buffsAndDebuffs.slow,
      );
      character.buffsAndDebuffs.bleed = rollCleanse(
        character.buffsAndDebuffs.bleed,
      );
      character.buffsAndDebuffs.poison = rollCleanse(
        character.buffsAndDebuffs.poison,
      );
      character.buffsAndDebuffs.bound = rollCleanse(
        character.buffsAndDebuffs.bound,
      );
      character.buffsAndDebuffs.paralyse = rollCleanse(
        character.buffsAndDebuffs.paralyse,
      );
      character.buffsAndDebuffs.burn = rollCleanse(
        character.buffsAndDebuffs.burn,
      );
      character.buffsAndDebuffs.awed = rollCleanse(
        character.buffsAndDebuffs.awed,
      );
      character.buffsAndDebuffs.cursed = rollCleanse(
        character.buffsAndDebuffs.cursed,
      );
      character.buffsAndDebuffs.freeze = rollCleanse(
        character.buffsAndDebuffs.freeze,
      );
      character.buffsAndDebuffs.confuse = rollCleanse(
        character.buffsAndDebuffs.confuse,
      );
      character.buffsAndDebuffs.fear = rollCleanse(
        character.buffsAndDebuffs.fear,
      );
      character.buffsAndDebuffs.entangled = rollCleanse(
        character.buffsAndDebuffs.entangled,
      );
      character.buffsAndDebuffs.soaked = rollCleanse(
        character.buffsAndDebuffs.soaked,
      );
      character.buffsAndDebuffs.stoneSkin = rollCleanse(
        character.buffsAndDebuffs.stoneSkin,
      );
      character.buffsAndDebuffs.petrify = rollCleanse(
        character.buffsAndDebuffs.petrify,
      );
      character.buffsAndDebuffs.choking = rollCleanse(
        character.buffsAndDebuffs.choking,
      );
      character.buffsAndDebuffs.corrupt = rollCleanse(
        character.buffsAndDebuffs.corrupt,
      );
      character.buffsAndDebuffs.wither = rollCleanse(
        character.buffsAndDebuffs.wither,
      );
    }
  ...
  static corrupt(character: Character): boolean {
    ...
    const raw =
      Dice.roll(DiceEnum.OneD4).sum + character.buffsAndDebuffs.corrupt;
...
export const EffectResolver: Record<
  BuffsAndDebuffsEnum,
...
> = {
  ...
  [BuffsAndDebuffsEnum.counterAttackCharge_1]:
    EffectResolverFunction.counterAttackCharge_1,
  [BuffsAndDebuffsEnum.counterAttackCharge_2]:
    EffectResolverFunction.counterAttackCharge_2,
  ...
  [BuffsAndDebuffsEnum.defensiveStance_1]:
    EffectResolverFunction.defensiveStance_1,
  [BuffsAndDebuffsEnum.defensiveStance_2]:
    EffectResolverFunction.defensiveStance_2,
  [BuffsAndDebuffsEnum.defensiveStance_3]:
    EffectResolverFunction.defensiveStance_3,
  [BuffsAndDebuffsEnum.fightingSpirit_1]:
    EffectResolverFunction.fightingSpirit_1,
  [BuffsAndDebuffsEnum.fightingSpirit_2]:
    EffectResolverFunction.fightingSpirit_2,
  [BuffsAndDebuffsEnum.fightingSpirit_3]:
    EffectResolverFunction.fightingSpirit_3,
  ...
  [BuffsAndDebuffsEnum.demonic_empowerment]:
    EffectResolverFunction.demoinc_empowerment,
