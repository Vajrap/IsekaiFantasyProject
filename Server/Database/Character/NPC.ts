...
export const NPCCharacterSeed: CharacterDB[] = [
    ...
    //MARK: EDMUND AZURE
    {
        ...
        status: {
            attributes: {
                charisma: { base: 14, exp: 0 },
                luck: { base: 12, exp: 0 },
                intelligence: { base: 14, exp: 0 },
                leadership: { base: 16, exp: 0 },
                vitality: { base: 14, exp: 0 },
                willpower: { base: 10, exp: 0 },
                breath: { base: 8, exp: 0 },
                planar: { base: 10, exp: 0 },
                dexterity: { base: 12, exp: 0 },
                agility: { base: 10, exp: 0 },
                strength: { base: 16, exp: 0 },
                endurance: { base: 16, exp: 0 },
            },
            proficiencies: {
    ...
    //MARK: ELARA AZURE
    {
        ...
        internalBuffs: {},
        position: 2, // Position 2 is front row in the middle, default for party leader
        itemsBag: [],
        baseAC: 7,
        location: "",
        isSummoned: false,
        ...
        bagSize: 20,
        relation: {
            [NPCID.npc_king_edmund_azure]: { value: 100, status: RelationEnum.Spouse },
            [NPCID.npc_princess_lysandra_azure]: { value: 100, status: RelationEnum.Family },
        },
    },
