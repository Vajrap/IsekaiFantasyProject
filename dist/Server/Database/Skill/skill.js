...
(function (SkillEnum) {
    ...
    // common
    // Physical Skills
    SkillEnum["skill_shield_bash"] = "skill_shield_bash";
    SkillEnum["skill_power_strike"] = "skill_power_strike";
    SkillEnum["skill_throw_knife"] = "skill_throw_knife";
    SkillEnum["skill_poison_coating"] = "skill_poison_coating";
    SkillEnum["skill_first_aid"] = "skill_first_aid";
    SkillEnum["skill_double_strike"] = "skill_double_strike";
    SkillEnum["skill_leap_attack"] = "skill_leap_attack";
    SkillEnum["skill_spear_thrust"] = "skill_spear_thrust";
    SkillEnum["skill_cleave"] = "skill_cleave";
    SkillEnum["skill_berserker_rage"] = "skill_berserker_rage";
    SkillEnum["skill_power_shot"] = "skill_power_shot";
    SkillEnum["skill_double_strafe"] = "skill_double_strafe";
    SkillEnum["skill_aimed_attack"] = "skill_aimed_attack";
    SkillEnum["skill_taunt"] = "skill_taunt";
    SkillEnum["skill_defensive_stance"] = "skill_defensive_stance";
    SkillEnum["skill_stealth"] = "skill_stealth";
    SkillEnum["skill_backstab"] = "skill_backstab";
    // Magic/Planar
    // arcane
    SkillEnum["skill_arcane_sword"] = "skill_arcane_sword";
    SkillEnum["skill_mage_reflex"] = "skill_mage_reflex";
    SkillEnum["skill_arcane_bolt"] = "skill_arcane_bolt";
    SkillEnum["skill_magic_missile"] = "skill_magic_missile";
    SkillEnum["skill_mana_shield"] = "skill_mana_shield";
    // order
    SkillEnum["skill_heal"] = "skill_heal";
    SkillEnum["skill_bless"] = "skill_bless";
    SkillEnum["skill_divine_flame"] = "skill_divine_flame";
    // chaos
    SkillEnum["skill_eldritch_blast"] = "skill_eldritch_blast";
    SkillEnum["skill_curse"] = "skill_curse";
    SkillEnum["skill_chill_touch"] = "skill_chill_touch";
    // geo
    SkillEnum["skill_rock_throw"] = "skill_rock_throw";
    // water
    SkillEnum["skill_water_beam"] = "skill_water_beam";
    // air
    SkillEnum["skill_air_blade"] = "skill_air_blade";
    // fire
    SkillEnum["skill_burning_hand"] = "skill_burning_hand";
    // nature
    SkillEnum["skill_starry_wisp"] = "skill_starry_wisp";
    SkillEnum["skill_entangle"] = "skill_entangle";
    SkillEnum["skill_rejuvenate"] = "skill_rejuvenate";
    // lightning
    SkillEnum["skill_shocking_grasp"] = "skill_shocking_grasp";
    // demonic
    ...
    SkillEnum["skill_battlecry"] = "skill_battlecry";
    SkillEnum["skill_charge"] = "skill_charge";
    SkillEnum["skill_roar"] = "skill_roar";
    SkillEnum["skill_triple_slash"] = "skill_triple_slash";
    SkillEnum["skill_caution"] = "skill_caution";
    // magical skills
    // order
    SkillEnum["skill_orderic_blast"] = "skill_orderic_blast";
    // chaos
    SkillEnum["skill_banish"] = "skill_banish";
    // geo
    SkillEnum["skill_stone_skin"] = "skill_stone_skin";
    SkillEnum["skill_earth_spike"] = "skill_earth_spike";
    // water
    SkillEnum["skill_drown"] = "skill_drown";
    // air
    SkillEnum["skill_storm_blast"] = "skill_storm_blast";
    // fire
    SkillEnum["skill_fire_ball"] = "skill_fire_ball";
    // ice = "ice",
    SkillEnum["skill_ice_nova"] = "skill_ice_nova";
    // spirit = "spirit",
    SkillEnum["skill_spirit_sword"] = "skill_spirit_sword";
    // lightning = "lightning",
    SkillEnum["skill_lightning_bolt"] = "skill_lightning_bolt";
    // demonic = "demonic",
    SkillEnum["skill_demonic_fire"] = "skill_demonic_fire";
    // metal = "metal",
    SkillEnum["skill_steel_spear"] = "skill_steel_spear";
    // angelic = "angelic",
    SkillEnum["skill_divine_light"] = "skill_divine_light";
    // life = "life",
    SkillEnum["skill_cleanse"] = "skill_cleanse";
    // dark = "dark",
    SkillEnum["skill_dark"] = "skill_dark";
    // ghost = "ghost",
    SkillEnum["skill_ghastly_touch"] = "skill_ghastly_touch";
    // poison = "poison",
    SkillEnum["skill_miasma"] = "skill_miasma";
    // arcane = "arcane",
    SkillEnum["skill_arcane_explosion"] = "skill_arcane_explosion";
    //rare
    SkillEnum["skill_iai_slash"] = "skill_iai_slash";
    //epic
    //legendary
    //unique
    //divine
...
const skillSeed = [
    ...
    new SkillArchetype({
        ...
        activeEffect: [
            new SkillActiveEffect(new TargetType(TargetPartyType.Ally, TargetSelectionScope.Single, TargetConditionFilters.IsSummoned, TargetSortingOptions.None, TargetTauntConsideration.NoTauntCount), [
    ...
    new SkillArchetype({
        ...
        activeEffect: [
            new SkillActiveEffect(new TargetType(TargetPartyType.Enemy, TargetSelectionScope.Single, TargetConditionFilters.None, TargetSortingOptions.None, TargetTauntConsideration.NoTauntCount), [
                new SkillActionObject({
    ...
    new SkillArchetype({
        ...
        equipmentNeeded: new SkillEquipmentRequirement({}),
        activeEffect: [
            new SkillActiveEffect(new TargetType(TargetPartyType.Enemy, TargetSelectionScope.AllFrontRowShiftable, TargetConditionFilters.None, TargetSortingOptions.None, TargetTauntConsideration.NoTauntCount), [
                new SkillActionObject({
                    type: SkillActionType.Negative,
                    subType: SkillActionSubType.Damage,
    ...
    new SkillArchetype({
        ...
        activeEffect: [
            new SkillActiveEffect(new TargetType(TargetPartyType.Enemy, TargetSelectionScope.AllFrontRowShiftable, TargetConditionFilters.None, TargetSortingOptions.None, TargetTauntConsideration.TauntCount), [
                new SkillActionObject({
                    type: SkillActionType.Negative,
                    subType: SkillActionSubType.Damage,
                    damageDiceBase: [DiceEnum.Weapon_Physical],
    ...
    new SkillArchetype({
        ...
        activeEffect: [
            new SkillActiveEffect(new TargetType(TargetPartyType.Enemy, TargetSelectionScope.Single, TargetConditionFilters.None, TargetSortingOptions.LowestHP, TargetTauntConsideration.NoTauntCount), [
                new SkillActionObject({
                    type: SkillActionType.Negative,
                    subType: SkillActionSubType.Damage,
                    damageDiceBase: [DiceEnum.Weapon_Physical],
    ...
    new SkillArchetype({
        ...
        activeEffect: [
            ...
            // 1st missile
            new TargetType(TargetPartyType.Enemy, TargetSelectionScope.Single, TargetConditionFilters.None, TargetSortingOptions.None, TargetTauntConsideration.TauntCount), [
                new SkillActionObject({
                    type: SkillActionType.Negative,
                    subType: SkillActionSubType.Damage,
    ...
    new SkillArchetype({
        ...
        activeEffect: [
            new SkillActiveEffect(new TargetType(TargetPartyType.Ally, TargetSelectionScope.Single, TargetConditionFilters.None, TargetSortingOptions.LowestHP, TargetTauntConsideration.NoTauntCount), [
                new SkillActionObject({
                    type: SkillActionType.Positive,
                    subType: SkillActionSubType.Heal,
    ...
    new SkillArchetype({
        ...
        activeEffect: [
            new SkillActiveEffect(new TargetType(TargetPartyType.Ally, TargetSelectionScope.Single, TargetConditionFilters.None, TargetSortingOptions.None, TargetTauntConsideration.NoTauntCount), [
                new SkillActionObject({
                    type: SkillActionType.Positive,
                    subType: SkillActionSubType.Buff,
                    damageDiceBase: [DiceEnum.None],
    ...
    new SkillArchetype({
        ...
        activeEffect: [
            new SkillActiveEffect(new TargetType(TargetPartyType.Ally, TargetSelectionScope.All, TargetConditionFilters.None, TargetSortingOptions.None, TargetTauntConsideration.NoTauntCount), [
                new SkillActionObject({
                    type: SkillActionType.Positive,
                    subType: SkillActionSubType.Buff,
                    damageDiceBase: [DiceEnum.None],
    ...
    new SkillArchetype({
        ...
        activeEffect: [
            new SkillActiveEffect(new TargetType(TargetPartyType.Enemy, TargetSelectionScope.All, TargetConditionFilters.None, TargetSortingOptions.None, TargetTauntConsideration.NoTauntCount), [
                new SkillActionObject({
                    type: SkillActionType.Negative,
                    subType: SkillActionSubType.Debuff,
                    damageDiceBase: [DiceEnum.None],
...
export function createSkillTableIfNotExists() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        isWeaponAttack TEXT
    `;
        yield createTableIfNotExists(tableName, tableStructure, skillSeed, 'id');
    });
}
