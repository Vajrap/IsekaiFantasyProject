...
const cloth_hood = new Headwear({
    ...
    cost: { baseCost: 60, bonusCost: 0, possibleDeviation: 0.2 },
    weight: 300,
    tier: Tier.common,
    armorType: ArmorType.cloth,
    material: 'Cloth',
...
const heavy_helm = new Headwear({
    ...
    cost: { baseCost: 2000, bonusCost: 0, possibleDeviation: 0.2 },
    weight: 4000,
    tier: Tier.rare,
...
const heavy_full_helm = new Headwear({
    ...
    cost: { baseCost: 2500, bonusCost: 0, possibleDeviation: 0.2 },
    weight: 4500,
    tier: Tier.rare,
    armorType: ArmorType.heavy,
    material: 'Steel',
